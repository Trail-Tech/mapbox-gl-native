...
void QMapboxGL::addSource(const QString &id, std::unique_ptr<QGeoJSONVT> data)
{
    using namespace mbgl::style;
    using namespace mbgl::style::conversion;
    ...
    auto source = std::make_unique<GeoJSONSource>(id.toStdString(),options);
...
void QMapboxGL::updateSource(const QString &id, std::unique_ptr<QGeoJSONVT> data)
{
    using namespace mbgl::style;
    using namespace mbgl::style::conversion;
